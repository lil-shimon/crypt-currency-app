package com.example.crypt_currency_app.domain.use_case.get_coins

import com.example.crypt_currency_app.common.Resource
import com.example.crypt_currency_app.data.remote.dto.toCoin
import com.example.crypt_currency_app.domain.model.Coin
...
class GetCoinsUseCase @Inject constructor(
    ...
    operator fun invoke(): Flow<Resource<List<Coin>>> = flow {
        try {
            ...
            emit(Resource.Success<List<Coin>>(coins)) // forwards to vm
